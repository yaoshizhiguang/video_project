# Episode 001 Segment 01 Progressive Birth Video Prompt v004 - Ice Magic No Crystals
...
本版基于 v003 另存，不覆盖原文件。重点修正：避免生成菱形冰晶、悬浮水晶、硬质冰片和廉价闪光碎片，把雪怪生成特效改写为细冰粉、霜雾、半透明雪粉、柔和冰蓝光带和流体螺旋运动。
...
2-4s: crisis begins in the same scene. One side of the sky darkens, wind rises, thin snow mist curls low across the ice, fine frost dust and translucent snow powder begin drifting upward like soft glowing vapor trails, animals look up nervously. No full monster yet, only a subtle stormy snow-cloud core behind the mid-sized icebergs.

4-6s: elemental monster formation. Behind the same icebergs, violent storm snow clouds, ground snow mist, cold wind streams, fine frost dust, translucent snow powder, and soft blue light ribbons gather into a living storm core. The effect should feel like premium icy magic made from fog, light, powder, and fluid motion, not like hard crystal props floating in the air. Two bright cold blue glowing eyes appear first inside the snow cloud; they are the first clear sign that the storm is alive. A faint dark cloud-hole mouth shadow only barely begins to appear beneath the eyes. The creature has no complete head yet, no complete round body yet, no solid arms yet, and no fully readable silhouette. Thick snow-cloud body masses are still forming out of rotating blizzard matter. The monster is not complete yet.

6-8s: half-formed reveal. The snowstorm monster rises higher and becomes mostly readable. Its upper body forms from thick dark storm cloud, rolling snow mist, translucent frost powder, and soft internal blue glow. Any solid ice decoration must remain attached to the monster body as tiny surface accents only, never as large floating rhombus crystals around it. The broad upper body and bulky side cloud masses are established, but the lower body still blends into a rotating snowstorm base. Animals begin fleeing, the fish bucket starts sliding.
